...
<table class="compare-table">
  <thead>
    <tr><th></th><th>Jelly stick</th><th>Gummy</th><th>Powder</th></tr>
  </thead>
  <tbody>
    <tr><td>Water needed</td><td>No</td><td>No</td><td>Yes</td></tr>
    <tr><td>Prep time</td><td>None — tear and go</td><td>None</td><td>1–2 min mixing</td></tr>
    <tr><td>Portability</td><td>High — flat, no spill risk</td><td>High</td><td>Low — needs a container</td></tr>
    <tr><td>Sugar content</td><td>Low-moderate (fruit-based)</td><td>Often high (gelatin base)</td><td>Usually none added</td></tr>
    <tr><td>Typical dose per serving</td><td>1,000–2,000mg</td><td>2–3 gummies, varies widely</td><td>Often highest (2,500mg+)</td></tr>
    <tr><td>UK availability</td><td>Import-only</td><td>Wide — Boots, H&amp;B, Superdrug</td><td>Wide — Boots, H&amp;B, Myprotein</td></tr>
    <tr><td>Typical price per serving (UK, imported where relevant)</td><td>~£0.70–£1.15</td><td>~£0.30–£0.60</td><td>~£0.50–£0.90</td></tr>
  </tbody>
</table>
...
**No added-sugar guilt.** Gummies rely on sugar and gelatin for their chew; jelly sticks lean on fruit concentrate for sweetness, which generally means a lower and more "food-like" sugar profile, though this varies brand to brand — always check the label.
...
**Dose flexibility.** Powders in particular let you adjust serving size easily — take a half scoop, a full scoop, add it to a smoothie. A jelly stick is a fixed dose.

**Established brands and third-party testing.** UK collagen brands like those sold through Boots, Holland & Barrett, and Myprotein have a longer track record in the UK market, with more consumer reviews and, in some cases, published testing.

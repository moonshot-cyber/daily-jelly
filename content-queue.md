...
`collagen-in-your-60s-and-beyond` is drafted (2026-09-11), committed with `draft: true`. Confirmed the 2025 knee-OA trial is genuinely Type I (Pangasius fish-skin peptides, explicitly stated), so it's safe to cite directly alongside the joints-vs-skin distinction. Three findings reported, each honestly scoped to who was actually studied: joint pain (mixed-sex, 3,000mg/day, 180 days), muscle/strength (men only, 15g/day + resistance training — same Zdzieblik et al. trial used in the men's-angle piece), bone density (women only, ~1 trial, flagged as the thinnest of the three). Still needs a `daily-jelly-publish-*` scheduled task created before 2026-09-30 — not created yet.
